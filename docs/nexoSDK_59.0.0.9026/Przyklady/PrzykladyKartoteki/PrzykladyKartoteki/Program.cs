    ...
    class Program
    {
        static void Main()
        {
			...
			using (var sfera = Uchwyty.UtworzNowy(daneDoUruchomienia, new PostepLadowaniaSfery()))
			{
				...
				_ = new ObslugaKartotek(sfera)
					.DodawanieDostawcow()
					.DodawanieAsortymentuZDodatkowymiJednostkamiMiary()
					.Zamienniki()
					.DodawanieKontaktowDoKlienta()
					.DodawanieKlientaZWielomaAdresami()
					.DodawanieKlientaZOddziałem()
					;
			}
		}
